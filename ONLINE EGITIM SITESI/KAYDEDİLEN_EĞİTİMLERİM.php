...
if (isset($_SESSION['kullaniciID'])) {
    ...
    $stmt = $conn->prepare("
        ...
        FROM KaydedilenEgitimler k
        INNER JOIN Egitimler e ON k.EgitimID = e.EgitimID
        WHERE k.OgrenciID = ?
    ");
...
<head>
    ...
    <title>Online Eğitim Sitesi - Kaydedilen Eğitimlerim</title>
    <link rel="stylesheet" href="KAYDEDİLEN_EĞİTİMLERİM.css">
