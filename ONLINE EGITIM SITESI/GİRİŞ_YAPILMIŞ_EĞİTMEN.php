...
<body>
    ...
    <nav>
        <div class="left-links">
            <a class="movement" href="GİRİŞ_YAPILMIŞ_EĞİTMEN.php">Ana Sayfa</a>
            <a class="movement" href="EĞİTİMLER_EĞİTMEN.">Eğitimler</a>
        </div>

        <div class="search-container">
            <form action="GİRİŞ_YAPILMIŞ_EĞİTMEN.php" method="GET">
        ...
        <div class="right-links">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="EĞİTMEN_EĞİTİMLERİM.php">Eğitimlerim</a>
                    <a href="ADMİN_PANELİ.html">Eğitim Yükle</a>
